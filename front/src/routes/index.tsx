...
import Homepage from "~/media/homepage.svg?jsx"
  ...
  return (
    <div class={style.landpage}>
      <div class={style.landpage_header}> 
        <div class={style.landpage_header_content}>
          <h1 class={style.landpage_header_title}>Le monde du travail n’a jamais été aussi facile</h1>
          <Link href="/sign" class={style.landpage_header_start}>Commencer</Link>
        </div>
        <Homepage class={style.landpage_header_image} />
