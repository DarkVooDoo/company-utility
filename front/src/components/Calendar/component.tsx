import { QRL, Resource, component$, useResource$, useSignal } from "@builder.io/qwik"
...
const Calendar = component$<Props>(({onChange, clasStyle: className, type = "single", hasMin = true, currentUser, currentCompany, betweenValue = []})=>{
            ...
            <Resource
                ...
                onResolved={({calendar})=>{
                    ...
                    return (
                        ...
                        ${isDayDisable && style.disabledDay}
